...
proto_udp_selftest(void)
{
    ...
    }
    {
        ...
        static const struct {
            ...
            {8600, 524, PROTO_VSTARCAM,
                "\x44\x48\x01\x08\x31\x39\x32\x2e\x30\x2e\x32\x2e\x32\x30\x00\x00"
                "\x00\x00\x00\x00\x32\x35\x35\x2e\x32\x35\x35\x2e\x32\x35\x35\x2e"
                "\x30\x00\x00\x00\x31\x39\x32\x2e\x30\x2e\x32\x2e\x31\x00\x00\x00"
                "\x00\x00\x00\x00\x32\x30\x33\x2e\x30\x2e\x31\x31\x33\x2e\x35\x33"
                "\x00\x00\x00\x00\x32\x30\x33\x2e\x30\x2e\x31\x31\x33\x2e\x35\x33"
                "\x00\x00\x00\x00\x02\x00\x00\x00\x00\x01\xa0\x46\x54\x45\x53\x54"
                "\x30\x30\x30\x30\x30\x31\x41\x42\x43\x44\x45\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x4c\x61\x62\x20"
                "\x63\x61\x6d\x65\x72\x61\x20\xe7\x9b\xb8\xe6\x9c\xba\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x36\x36\x2e\x38"
                "\x31\x2e\x32\x30\x34\x2e\x31\x39\x00\x00\x00\x00\x76\x61\x72\x20"
                "\x61\x70\x70\x5f\x76\x65\x72\x3d\x22\x43\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
            ...
            {1604, 40, PROTO_CITRIX,
                "\x28\x00\x04\x33\x02\xfd\xa8\xe3\x02\x00\x06\x44\xc0\x00\x02\x01"
                "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00"
                "\x00\x00\x00\x00\x00\x00\x00\x00"},
            {1604, 154, PROTO_CITRIX,
        ...
        for (f = 0; f < sizeof(fixtures) / sizeof(*fixtures); f++) {
            ...
            parsed.port_dst = parsed.port_src == 8600 ? 8601 : 40000;
