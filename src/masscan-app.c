...
masscan_app_to_string(enum ApplicationProtocol proto)
{
    ...
    case PROTO_EPM:              return "epm";
    case PROTO_PNIO:             return "pnio";
    ...
    case PROTO_CITRIX:           return "citrix";
    case PROTO_VSTARCAM:         return "vstarcam";
...
masscan_app_selftest(void) {
    ...
    if (masscan_string_to_app("enip") != PROTO_ENIP ||
        ...
        return 1;
    if (masscan_string_to_app("mdns") != PROTO_MDNS ||
        strcmp(masscan_app_to_string(PROTO_MDNS), "mdns") != 0)
        return 1;
    ...
    if (masscan_string_to_app("bacnet") != PROTO_BACNET ||
        ...
        return 1;
    if (masscan_string_to_app("ssdp") != PROTO_SSDP ||
        strcmp(masscan_app_to_string(PROTO_SSDP), "ssdp") != 0)
        return 1;
    ...
    if (masscan_string_to_app("jenkins") != PROTO_JENKINS ||
        ...
        return 1;
    if (masscan_string_to_app("dtls") != PROTO_DTLS ||
        strcmp(masscan_app_to_string(PROTO_DTLS), "dtls") != 0)
        return 1;
    return 0;
}
